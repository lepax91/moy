exports.run = (OptiX, message, args) => {
    ...
    if(gamemode != 'solos' && gamemode != 'duos' && gamemode != 'squads' && gamemode != 'lifetime') return message.channel.send('Musíš vybrat jednu z možností: `solos`, `duos`, `squads`, `lifetime`.');
        
    if (!username) return message.channel.send(":x: | Zadej uživatele, který existuje ve Fortnitu!");
